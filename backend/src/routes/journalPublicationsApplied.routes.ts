...
const schema = z.object({
  ...
  indexing_others_specify: z.preprocess(
    (value) => {
...
router.post('/', upload.single('proofFile'), async (req, res) => {
  try {
    const rawBody = {
      ...req.body,
      faculty_id: req.body.faculty_id ?? req.body.faculty,
      indexing_type: req.body.indexing_type ?? req.body.indexing,
      indexing_others_specify: req.body.indexing_others_specify ?? req.body.otherIndexing,
      journal_name: req.body.journal_name ?? req.body.journalName,
      submitted_journal_title: req.body.submitted_journal_title ?? req.body.submittedTitle,
      submitted_date: req.body.submitted_date ?? req.body.submittedDate,
      publication_status: req.body.publication_status ?? req.body.status,
    };
